      ...
      <div>
            ...
            <li>
               ...
               <ul>
                  <li>
                     ...
                     <br />
                     Include <pre className="d-inline">shuffle</pre> at the beginning or end of the maps list
                     to pick maps in a random order
                     <br />
                     List maps by id, to change the selected mod put the mod ahead of the list of maps that
                     use it. Eg:
                     <br />
                     <pre className="border rounded p-1 d-inline lh-lg">
                        !quali osu nm 5188789 4956990 5210676 hd 5353008 4756048 hr 5248344 5288370 dt 5192352
                        4916977 fm 5349133 5045601 shuffle
                     </pre>
                     <br />
         ...
         <ul>
            ...
            <li>
               ...
               <ul>
                  <li>
                     <pre className="border rounded p-1 d-inline lh-lg">!auto [mode]</pre> - Create a lobby
